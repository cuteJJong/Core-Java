...
public class OuterClass1 {
    public static void main(String[] args) {
        OuterClass1.InnerClass1 ic = new OuterClass1.InnerClass1();     //inner 클래스는 inner 클래스의 주소를 필요로 하지않는다.
        ic.display();
        ic.print();
    }
    ...
    private static class InnerClass1 {   //static inner class
        ...
        public void display() {  //static inner class's member method
            //System.out.println(a);      //outer class의 주소가 필요.
            System.out.println(b + "," + c + "," + d);
        }
        public static void print() {
            //System.out.println(a + "," + c);      //outer class의 주소가 필요.
