...
* Lambda & Stream API
* 1.Lambda
*   1)원래 객체지향언어에서 사용하지 않고, Scala 나 Groovy 같은 함수형 언어에서 사용하던 문법
*   2) 메소드는 클래스안에서 객체의 행위를 정의하지만, Expression이라고 쓴 이유는 Method의 역할과 동일하지만 특정
*       클래스 소속이 아니기 때문이다.
*   3) Lambda Expression을 사용하면서 매개변수와 리턴 타임만으로 코드를 작성할 수 있기 때문에,
*       병령 프로그래밍을 하지 않아도 되어 Collection Framework에서 효과적인 코드를 작성할 수 있다.
*   4) 순서
*       -객체의 생성부분을 삭제한다.
